...
public class O365TestsCDS extends GWCommonTest{
	...
	@Priority(1)
	@Test(groups ={"CDS"}, retryAnalyzer=RetryAnalyzer.class)
	...
	@Priority(2)
	@Test(groups ={"CDS"},retryAnalyzer=RetryAnalyzer.class)  //,dependsOnMethods = { "loginToCloudSocAppAndSetupSSO" }
	...
	@Priority(3)
	@Test(groups ={"CDS"}, retryAnalyzer=RetryAnalyzer.class) //dependsOnMethods = { "o365_Test_01_ValidateLogingActivityEvent" }
	...
	@Priority(7)
	@Test(groups ={"CDS"}) //,dependsOnMethods = { "o365_Test_01_ValidateLogingActivityEvent" }
