...
public class UsersGroupsExternalFSPolicyTest extends CommonConfiguration {
	...
	@BeforeClass
	public void EnableExternalUserMonitoring() throws Exception {
		Reporter.log("Enable Monitoring of External Users", true);
		
		String tenantAcctId = getTenantAccountId();
		String payload = "{\"id\":\""+tenantAcctId+"\",\"data\":{\"is_monitoring\":true,\"enable_nodomain_as_external\":true,\"applications\":[\"__ALL_EL__\"],\"applications_whitelist\":[]}}";
		Reporter.log("Payload:"+ payload, true);
		String responseBody = updateMonitoringStatus(payload);
		Reporter.log("Response body:"+ responseBody, true);
	}
	
	@AfterClass
	public void DisableExternalUserMonitoring() throws Exception {
		Reporter.log("Disable Monitoring of External Users", true);
		
		String tenantAcctId = getTenantAccountId();
		String payload = "{\"id\":\""+tenantAcctId+"\",\"data\":{\"is_monitoring\":false,\"enable_nodomain_as_external\":true,\"applications\":[\"__ALL_EL__\"],\"applications_whitelist\":[]}}";
		Reporter.log("Payload:"+ payload, true);
		String responseBody = updateMonitoringStatus(payload);
		Reporter.log("Response body:"+ responseBody, true);
	}
