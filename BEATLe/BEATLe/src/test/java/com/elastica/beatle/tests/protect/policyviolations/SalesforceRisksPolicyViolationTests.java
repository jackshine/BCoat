 ...
 *
 */
public class SalesforceRisksPolicyViolationTests extends ProtectInitializeTests {
	 ...
	 * @throws Exception
	 */
	@Test(dataProviderClass = SalesforceDataProvider.class, dataProvider = "ContentProfileRisks", priority = 2)
	...
	public Object[][] getDataList() {
		...
		list.add(SalesforceDataProvider.getSalesforceRisksPolicyViolationsDataProvider());
