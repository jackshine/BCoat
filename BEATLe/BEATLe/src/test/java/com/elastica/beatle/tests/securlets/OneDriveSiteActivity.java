...
public class OneDriveSiteActivity {
	...
	public OneDriveSiteActivity(String message, String createdTime, String severity, String objectType, String activityType, 
			String saasuser, String resourceId, String fileSize, String parent, String listname, String sitename, String facility, 
			String instance, String currentlySharedWith, String unsharedWith) {
	...
	public OneDriveSiteActivity(String message, String createdTime, String severity, String activityType, 
	...
	public OneDriveSiteActivity(HashMap<String, String> parameters) {
