...
public class UsersGroupsAEPolicyTest extends CommonConfiguration {
	...
	@Test(dataProvider = "AE_DocumentRecyclebin")
	public void verify_UserAndGroupsAE_DocumentRecyclebinPolicy(String testUser, String testUserGroup, String policyUser, String policyGroup, String objectAccess, String activityAccess, Boolean verifyBlocked, String logFile, String tcId) throws Exception{
		Reporter.log("Validate User and Groups for AE Policy with Document and Recyclebin object.", true);
	...
	@DataProvider
	public Object[][] AE_DocumentRecyclebin() {
		return new Object[][]{
			...
			{"testuser1", "GroupA", "", "GroupA", "Recycle Bin", "Empty", true, "RecycleBin,Empty_OneNote.log", "C00100"},
			{"testuser1", "GroupA", "", "GroupA", "Recycle Bin", "Empty", false, "OneDrive,Create_folder.log", "C00200"},
			{"testuser1", "", "", "GroupA", "Recycle Bin", "Empty", false, "RecycleBin,Empty_OneNote.log", "C00300"},
			{"testuser1", "GroupB", "", "GroupA", "Recycle Bin", "Empty", false, "RecycleBin,Empty_OneNote.log", "C00400"},
			{"testuser1", "", "testuser1@gatewayo365beatle.com", "", "Recycle Bin", "Empty", true, "RecycleBin,Empty_OneNote.log", "C00500"},
			{"testuser1", "", "testuser1@gatewayo365beatle.com", "", "Recycle Bin", "Empty", false, "OneDrive,Create_folder.log", "C00600"},
			{"testuser1", "GroupA", "testuser1@gatewayo365beatle.com", "", "Recycle Bin", "Empty", true, "RecycleBin,Empty_OneNote.log", "C00700"},
			{"testuser1", "GroupA", "admin@gatewayo365beatle.com", "", "Recycle Bin", "Empty", false, "RecycleBin,Empty_OneNote.log", "C00800"},
			{"testuser1", "GroupA", "admin@gatewayo365beatle.com", "GroupA", "Recycle Bin", "Empty", true, "RecycleBin,Empty_OneNote.log", "C00900"},
			{"testuser1", "", "testuser1@gatewayo365beatle.com", "GroupA", "Recycle Bin", "Empty", true, "RecycleBin,Empty_OneNote.log", "C01100"},
		};
	}
	
	@Test(dataProvider = "AE_Document_FolderOperations")
	public void verify_UserAndGroupsAE_Document_FolderOperationsPolicy(String testUser, String testUserGroup, String policyUser, String policyGroup, String objectAccess, String activityAccess, String fileName, Boolean verifyBlocked, String logFile, String tcId) throws Exception{
	...
	@DataProvider
	public Object[][] AE_Document_FolderOperations() {
		return new Object[][]{
