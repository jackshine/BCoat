...
public class GoogleDriveThreatScoreTests extends ProtectInitializeTests {
	...
	public Object[][] getData() {
		return new Object[][] {
			new String[] { "TSPOLICY1", "Google Drive", "any", 					   "Any", "Any", "protectauto1@protectbeatle.com", "No", "10", "BLOCK_SERVICE"},
			new String[] { "TSPOLICY2", "Google Drive", "admin@protectbeatle.com", "Any", "Any", "protectauto1@protectbeatle.com", "No", "0",  "BLOCK_SERVICE"},
			new String[] { "TSPOLICY3", "Google Drive", "admin@protectbeatle.com", "Any", "Any", "no",   						   "No", "10", "BLOCK_SERVICE"},
		};
	}
	...
	public void testThreatScorePolicy(List<String[]> list) throws Exception {
		...
		universalApi.uploadFile(folderId, file.getAbsolutePath(), file.getName());
