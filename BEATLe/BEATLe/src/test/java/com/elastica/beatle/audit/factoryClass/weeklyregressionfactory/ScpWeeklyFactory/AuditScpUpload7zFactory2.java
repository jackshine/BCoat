 ...
 *
 */
public class AuditScpUpload7zFactory2{
	...
	public Object[] SCPUploadFactoryMethod(){
		return new Object[]{
				...
				new AuditWeeklyRegressionScpUploadTests(AuditWeeklyRegressionConstants.BLUECOAT_PROXY_CUSTOM_HEADER_QUOTE_HEADER_7Z),
				new AuditWeeklyRegressionScpUploadTests(AuditWeeklyRegressionConstants.BLUECOAT_PROXY_CUSTOM_HEADER_SPACE_HEADER_7Z),
