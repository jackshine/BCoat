...
public class LogReplayServer extends Thread{
	...
	public LogReplayServer(String userName, String logFolderName){
	...
	/*public static void main(String[] args) {
		...
		LogReplayServer ssha = new LogReplayServer("usman", "box");
		ssha.injectActivityLogs();
		
	}*/

	
	public  String injectActivityLogs() {
		String consoleLog = "";
		System.out.println("userName: "+userName);
		System.out.println("log folder: "+logFolderName);
...
public void run() {
	 System.out.println("Hello Java  thread1");
	 injectActivityLogs();
	    System.out.println("Hello Java  threa");
	  }
