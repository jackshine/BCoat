...
public class DCIPCIPIINewTests extends DCICommonTest implements ITest {
	...
	@Test(dataProvider = "dataUploadPIIAddressScenarios", groups ={"Address"})
	public void testDisplayLogsGenerateRiskForPIIRiskAddressScenarios(TestParameters testParams) throws Exception {
	...
	public Object[][] dataUploadPIIPositiveScenarios() {
		...
		String[] fileName = dciFunctions.getFileName(DCIConstants.DCI_FILE_UPLOAD_PCI_PII_NEW_POS_PATH);
		...
		fileName = dciFunctions.createSampleFileType(DCIConstants.DCI_FILE_UPLOAD_PCI_PII_NEW_POS_PATH,
				fileName);
	...
	public Object[][] dataUploadPIINegativeScenarios() {
		...
		String[] fileName= dciFunctions.getFileName(DCIConstants.DCI_FILE_UPLOAD_PCI_PII_NEW_NEG_PATH);

		fileName = dciFunctions.createSampleFileType(DCIConstants.DCI_FILE_UPLOAD_PCI_PII_NEW_NEG_PATH,
				fileName);
		dciFunctions.fileUploadOrSendEmail(suiteData, folderInfo, fileName);
	...
	@DataProvider(name = "dataUploadPIIAddressScenarios")
	public Object[][] dataUploadPIIAddressScenarios() {

		dciFunctions = new DCIFunctions();

		String[] fileName = dciFunctions.getFileName(DCIConstants.DCI_FILE_UPLOAD_PII_ADDRESS_PATH);
		String[] title = new String[fileName.length];String[] description = new String[fileName.length];
		String[] risks = dciFunctions.riskTypesForAFile(fileName);
		...
		fileName = dciFunctions.createSampleFileType(DCIConstants.DCI_FILE_UPLOAD_PII_ADDRESS_PATH,
				fileName);
	 ...
	 */
	@BeforeClass(groups ={"All","Address"})
	...
	@BeforeMethod(groups ={"All","Address"})
