 ...
 *
 */
public class Office365RemoveExternalCollaboratorTests extends ProtectInitializeTests {
	 ...
	 * @throws Exception
	 */
	@Test(dataProviderClass = O365DataProvider.class, dataProvider = "RemoveExternalCollaboratorDataProvider", priority = 2)
	...
	public Object[][] getDataList() {
		...
		list.add(O365DataProvider.getRemoveExternalCollaboratorDataProvider());
