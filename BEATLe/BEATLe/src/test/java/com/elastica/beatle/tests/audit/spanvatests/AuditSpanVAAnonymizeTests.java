...
public class AuditSpanVAAnonymizeTests extends AuditInitializeTests{
	...
	public AuditSpanVAAnonymizeTests(String FireWallName) {
	...
	public void getUserAnonymization() throws Exception
	{
	...
	@Test(dependsOnMethods={"getUserAnonymization"})
...
/*
	...
	@Test(dependsOnMethods={"testSpanVADatasourceCreation"})
	public void getUserAnonymizationOfConsumerServices() throws Exception
	{
		Reporter.log("sourceID:"+sourceID,true);
		SortedSet<String> actulAnonyUsersSet=null;
		SortedSet<String> expectedAnonyUsersSet=null;
		...
		case AuditTestConstants.FIREWALL_BE_BLUECOAT_PROXY_GZ:{
			...
			goldenSetTestDataSetup=new AuditGoldenSetTestDataSetup(goldenSetDataList);
			expectedAnonyUsersSet=goldenSetTestDataSetup.getExpectedAnonyUsers(goldenSetDataList);
			actulAnonyUsersSet=AuditTestUtils.getDatasourceAnonyUsersOfConsumerServices(sourceID,"86400","1394928000","1397519999",true);
			Assert.assertEquals(actulAnonyUsersSet.size(), expectedAnonyUsersSet.size(),"Anony User count is not Matched");
		...
		case AuditTestConstants.FIREWALL_BE_ZSCALAR_GZ:{
			...
			goldenSetTestDataSetup=new AuditGoldenSetTestDataSetup(goldenSetDataList);
			expectedAnonyUsersSet=goldenSetTestDataSetup.getExpectedAnonyUsers(goldenSetDataList);
			actulAnonyUsersSet=AuditTestUtils.getDatasourceAnonyUsersOfConsumerServices(sourceID,"86400","1432857600","1435449599",true);
			Assert.assertEquals(actulAnonyUsersSet.size(), expectedAnonyUsersSet.size(),"Anony User count is not Matched");
		...
		case AuditTestConstants.FIREWALL_BE_WSAW3C_GZ:{
			...
			goldenSetTestDataSetup=new AuditGoldenSetTestDataSetup(goldenSetDataList);
			expectedAnonyUsersSet=goldenSetTestDataSetup.getExpectedAnonyUsers(goldenSetDataList);
			actulAnonyUsersSet=AuditTestUtils.getDatasourceAnonyUsersOfConsumerServices(sourceID,"86400","1412467200","1415059199",true);
			Assert.assertEquals(actulAnonyUsersSet.size(), expectedAnonyUsersSet.size(),"Anony User count is not Matched");
	...
	@Test(dependsOnMethods={"getUserAnonymizationOfConsumerServices"})
