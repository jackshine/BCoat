 ...
 *
 */
public class AuditWebUpload7zFactory2{
	...
	public Object[] WebUploadFactoryMethod(){
		return new Object[]{
				...
				new AuditWeeklyRegressionWebUploadTests(AuditWeeklyRegressionConstants.BLUECOAT_PROXY_CUSTOM_HEADER_QUOTE_HEADER_7Z),
				new AuditWeeklyRegressionWebUploadTests(AuditWeeklyRegressionConstants.BLUECOAT_PROXY_CUSTOM_HEADER_SPACE_HEADER_7Z),
