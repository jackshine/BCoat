 ...
 *
 */
public class Office365MailStressTests2 extends CommonTest {
	...
	public Office365MailStressTests2() throws Exception {
		super();
	...
	public Object[][] dataProviderCount() {
		...
		return new Object[][]{
			...
			{"Please find your documents",	 		1,						10000	},
...
//			{"Please find your documents",	 		9001,					10000	}
	...
	public void searchInFolder(String subject, int userStartingRange, int userEndingRange) throws IOException, InterruptedException {
		...
		try {
			...
			inboxCount		 += objMail.searchItemAndReturnCount("Please find your documents","Inbox");
			sentItemsCount	 += objMail.searchItemAndReturnCount("Please find your documents","SentItems");
			draftCount 		 += objMail.searchItemAndReturnCount("Draft","Drafts");
