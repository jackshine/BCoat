 ...
 *
 */
public class AuditScpUploadb2zFactory2{
	...
	public Object[] SCPUploadFactoryMethod(){
		return new Object[]{
				...
				new AuditWeeklyRegressionScpUploadTests(AuditWeeklyRegressionConstants.BLUECOAT_PROXY_CUSTOM_HEADER_QUOTE_HEADER_BZ2),
				new AuditWeeklyRegressionScpUploadTests(AuditWeeklyRegressionConstants.BLUECOAT_PROXY_CUSTOM_HEADER_SPACE_HEADER_BZ2),
