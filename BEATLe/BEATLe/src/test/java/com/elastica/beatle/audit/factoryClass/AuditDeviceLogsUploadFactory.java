 ...
 *
 */
public class AuditDeviceLogsUploadFactory {
	/**
	 * @return
	 */
	@Factory
	public Object[] DeviceLogsUploadFactoryMethod(){
		return new Object[]{
				...
				new AuditWebuploadDeviceLogsTests(AuditTestConstants.FIREWALL_PAN_SYS_MULTIPLE_DEVICE_IDS),
				new AuditWebuploadDeviceLogsTests(AuditTestConstants.FIREWALL_WSA_ACCESS_DEVICE_IDS),
				new AuditWebuploadDeviceLogsTests(AuditTestConstants.FIREWALL_BLUECOAT_PROXYSG_DEVICE_IDS),
				...
				new AuditScpDeviceLogsTests(AuditTestConstants.FIREWALL_BLUECOAT_PROXYSG_DEVICE_IDS),
				
				
				new AuditS3DeviceLogsTests(AuditTestConstants.FIREWALL_CWS_MULTIPLE_DEVICE_IDS),
				new AuditS3DeviceLogsTests(AuditTestConstants.FIREWALL_PAN_CSV_MULTIPLE_DEVICE_IDS),
				new AuditS3DeviceLogsTests(AuditTestConstants.FIREWALL_PAN_SYS_MULTIPLE_DEVICE_IDS),
