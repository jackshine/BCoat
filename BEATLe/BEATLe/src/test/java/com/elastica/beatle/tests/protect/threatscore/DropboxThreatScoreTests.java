...
public class DropboxThreatScoreTests extends ProtectInitializeTests {
	...
	public Object[][] getData() {
		return new Object[][] {
			 ...
			 * 10. Password 
			 */
			new String[] { "TSDBPOLICY1", "Dropbox", "any", 						  "Any", "Any", "protectauto@protectbeatle.com", "No", "10", "BLOCK_SERVICE"},
			new String[] { "TSDBPOLICY2", "Dropbox", "admin@protectbeatle.com", "Any", "Any", "protectauto@protectbeatle.com", "No", "0",  "BLOCK_SERVICE"},
			new String[] { "TSDBPOLICY3", "Dropbox", "admin@protectbeatle.com", "Any", "Any", "no",   				   "No", "10", "BLOCK_SERVICE"},
