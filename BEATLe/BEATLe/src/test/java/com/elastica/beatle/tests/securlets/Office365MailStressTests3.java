 ...
 *
 */
public class Office365MailStressTests3 extends CommonTest {
	...
	public Office365MailStressTests3() throws Exception {
		super();
	...
	public Object[][] dataProviderCount() {
		...
		return new Object[][]{
			...
			{"Please find your documents",	 		1,						1000	},
			{"Please find your documents",	 		1001,					2000	},
			{"Please find your documents",	 		2001,					3000	},
			{"Please find your documents",	 		3001,					4000	},
			{"Please find your documents",	 		4001,					5000	},
			{"Please find your documents",	 		5001,					6000	},
			{"Please find your documents",	 		6001,					7000	},
			{"Please find your documents",	 		7001,					8000	},
			{"Please find your documents",	 		8001,					9000	},
			{"Please find your documents",	 		9001,					10000	}
			
		};
	}
	
	@Test( dataProvider="dataProviderCount")
	public void searchInFolder(String subject, int userStartingRange, int userEndingRange) throws IOException, InterruptedException {
		...
		try {
			...
			countInbox		 = objMail.searchItemAndReturnCount("Please find your documents","Inbox");
			countSent	 	 = objMail.searchItemAndReturnCount("Please find your documents","SentItems");
			countDrafts 		 = objMail.searchItemAndReturnCount("Draft","Drafts");
			
			showCount(countInbox,countSent,countDrafts);
			objMail=null;
...
public  synchronized  void showCount(long countInbox,long countSent, long countDrafts)
{
	inboxCount+=countInbox;
	sentItemsCount+=countSent;
	draftCount+=countDrafts;
	totalCount = inboxCount+sentItemsCount+draftCount;
	
	Reporter.log("Total inbox mails sofar="+inboxCount, true);
	Reporter.log("Total sent  mails sofar="+sentItemsCount, true);
...
@Test( dataProvider="dataProviderCount")
public void totalCountInFolders(String subject, int userStartingRange, int userEndingRange) throws IOException, InterruptedException {
...
//		mailAttachments.add("encryption.bin");
		...
		return new Object[][]{
			...
			{"send_mail",		"internal", 		9980,						9980,				"attachment",		mailAttachments, 		25,						   	getInternalRecepientList(2001, 2100), 	null, 			null},
			{"send_mail",		"external", 		2001,						2100,				"attachment",		mailAttachments, 		25,						  	 externalIds, 	null, 			null},
			{"send_mail",		"group", 			2001,						2100,				"attachment",		mailAttachments, 		25,						  	 groupIds, 	null, 			null},
			{"save_indrafts",	"draft", 			2001,						2100,				"attachment",		mailAttachments, 		25,						  	 null, 	null, 			null},
		
			{"send_mail",		"internal", 		9979,						9979,				"attachment",		mailAttachments, 		25,						   	getInternalRecepientList(2101, 2200), 	null, 			null},
			{"send_mail",		"external", 		2101,						2200,				"attachment",		mailAttachments, 		25,						  	 externalIds, 	null, 			null},
			{"send_mail",		"group", 			2101,						2200,				"attachment",		mailAttachments, 		25,						  	 groupIds, 	null, 			null},
			{"save_indrafts",	"draft", 			2101,						2200,				"attachment",		mailAttachments, 		25,						  	 null, 	null, 			null},
			
			{"send_mail",		"internal", 		9978,						9978,				"attachment",		mailAttachments, 		25,						   	getInternalRecepientList(2201,2300), 	null, 			null},
			{"send_mail",		"external", 		2201,						2300,				"attachment",		mailAttachments, 		25,						  	 externalIds, 	null, 			null},
			{"send_mail",		"group", 			2201,						2300,				"attachment",		mailAttachments, 		25,						  	 groupIds, 	null, 			null},
			{"save_indrafts",	"draft", 			2201,						2300,				"attachment",		mailAttachments, 		25,						  	 null, 	null, 			null},
			
			{"send_mail",		"internal", 		9977,						9977,				"attachment",		mailAttachments, 		25,						   	getInternalRecepientList(2301, 2400), 	null, 			null},
			{"send_mail",		"external", 		2301,						2400,				"attachment",		mailAttachments, 		25,						  	 externalIds, 	null, 			null},
			{"send_mail",		"group", 			2301,						2400,				"attachment",		mailAttachments, 		25,						  	 groupIds, 	null, 			null},
			{"save_indrafts",	"draft", 			2301,						2400,				"attachment",		mailAttachments, 		25,						  	 null, 	null, 			null},
			
			{"send_mail",		"internal", 		9976,						9976,				"attachment",		mailAttachments, 		25,						   	getInternalRecepientList(2401, 2500), 	null, 			null},
			{"send_mail",		"external", 		2401,						2500,				"attachment",		mailAttachments, 		25,						  	 externalIds, 	null, 			null},
			{"send_mail",		"group", 			2401,						2500,				"attachment",		mailAttachments, 		25,						  	 groupIds, 	null, 			null},
			{"save_indrafts",	"draft", 			2401,						2500,				"attachment",		mailAttachments, 		25,						  	 null, 	null, 			null},
			
			{"send_mail",		"internal", 		9975,						9975,				"attachment",		mailAttachments, 		25,						   	getInternalRecepientList(2501, 2600), 	null, 			null},
			{"send_mail",		"external", 		2501,						2600,				"attachment",		mailAttachments, 		25,						  	 externalIds, 	null, 			null},
			{"send_mail",		"group", 			2501,						2600,				"attachment",		mailAttachments, 		25,						  	 groupIds, 	null, 			null},
			{"save_indrafts",	"draft", 			2501,						2600,				"attachment",		mailAttachments, 		25,						  	 null, 	null, 			null},
			
			{"send_mail",		"internal", 		9974,						9974,				"attachment",		mailAttachments, 		25,						   	getInternalRecepientList(2601, 2700), 	null, 			null},
			{"send_mail",		"external", 		2601,						2700,				"attachment",		mailAttachments, 		25,						  	 externalIds, 	null, 			null},
			{"send_mail",		"group", 			2601,						2700,				"attachment",		mailAttachments, 		25,						  	 groupIds, 	null, 			null},
			{"save_indrafts",	"draft", 			2601,						2700,				"attachment",		mailAttachments, 		25,						  	 null, 	null, 			null},
			
			{"send_mail",		"internal", 		9973,						9973,				"attachment",		mailAttachments, 		25,						   	getInternalRecepientList(2701, 2800), 	null, 			null},
			{"send_mail",		"external", 		2701,						2800,				"attachment",		mailAttachments, 		25,						  	 externalIds, 	null, 			null},
			{"send_mail",		"group", 			2701,						2800,				"attachment",		mailAttachments, 		25,						  	 groupIds, 	null, 			null},
			{"save_indrafts",	"draft", 			2701,						2800,				"attachment",		mailAttachments, 		25,						  	 null, 	null, 			null},
			
			{"send_mail",		"internal", 		9972,						9972,				"attachment",		mailAttachments, 		25,						   	getInternalRecepientList(2801, 2900), 	null, 			null},
			{"send_mail",		"external", 		2801,						2900,				"attachment",		mailAttachments, 		25,						  	 externalIds, 	null, 			null},
			{"send_mail",		"group", 			2801,						2900,				"attachment",		mailAttachments, 		25,						  	 groupIds, 	null, 			null},
			{"save_indrafts",	"draft", 			2801,						2900,				"attachment",		mailAttachments, 		25,						  	 null, 	null, 			null},
			
			{"send_mail",		"internal", 		9971,						9971,				"attachment",		mailAttachments, 		25,						   	getInternalRecepientList(2901, 3000), 	null, 			null},
			{"send_mail",		"external", 		2901,						3000,				"attachment",		mailAttachments, 		25,						  	 externalIds, 	null, 			null},
			{"send_mail",		"group", 			2901,						3000,				"attachment",		mailAttachments, 		25,						  	 groupIds, 	null, 			null},
			{"save_indrafts",	"draft", 			2901,						3000,				"attachment",		mailAttachments, 		25,						  	 null, 	null, 			null},
