 ...
 *
 */
public class AuditScpUpload7zaFactory2{
	...
	public Object[] SCPUploadFactoryMethod(){
		return new Object[]{
				...
				new AuditWeeklyRegressionScpUploadTests(AuditWeeklyRegressionConstants.BLUECOAT_PROXY_CUSTOM_HEADER_QUOTE_HEADER_7ZA),
				new AuditWeeklyRegressionScpUploadTests(AuditWeeklyRegressionConstants.BLUECOAT_PROXY_CUSTOM_HEADER_SPACE_HEADER_7ZA),
