 ...
 *
 */
public class AuditS3Upload7zaFactory2{
	...
	public Object[] S3UploadFactoryMethod(){
		return new Object[]{
				...
				new AuditWeeklyRegressionS3UploadTests(AuditWeeklyRegressionConstants.BLUECOAT_PROXY_CUSTOM_HEADER_QUOTE_HEADER_7ZA),
				new AuditWeeklyRegressionS3UploadTests(AuditWeeklyRegressionConstants.BLUECOAT_PROXY_CUSTOM_HEADER_SPACE_HEADER_7ZA),
