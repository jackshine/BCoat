...
public class SalesforceEpdTest extends CommonConfiguration {
	...
	public void verify_User_logged_in_1024_1025_1026(String activityType, String objectType, String severity, String expectedMsg, String logFile) throws IOException, Exception{
		...
		replayLogs(logFile);
		fsr=fetchElasticSearchLogs(activityType, objectType, severity);    //fetch the logs from ES
		messages=processLogs(fsr);										//Process the messages from logs
		assertTrue(validateMessgaeBody(messages, expectedMsg), "Logs does not match" ); //Assert the messages
	}
	...
	public void verify_User_PostedAComment_(String activityType, String objectType, String objectName, String severity, String logFile) throws Exception{
		...
		messages=processLogs(fsr);													//Process the messages from logs
		objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
		Assert.assertTrue(validateMessgaeBody(messages, expectedMsg), "Logs does not match" );    //Validate the messages
		//Assert.assertTrue(validateObjectName(messages, objectNameList, objectName, expectedMsg), "Object Name does not match" ); //Object Names validation
	...
	public void verify_User_deleteComment_1052(String activityType, String objectType, String commentText, String severity, String logFile) throws Exception{
		...
		objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
		Assert.assertTrue(validateMessgaeBody(messages, expectedMsg), "Logs does not match" );    //Validate the messages
		Assert.assertTrue(validateObjectName(messages, objectNameList, commentText, expectedMsg), "Object Name does not match" ); //Object Names validation
	...
	public Object[][] _1151() {
		return new Object[][]{
			//Activity type  Object Type  Object Name, DestinationDolder  Severity  message
			{ "Delete",    "Account", "Testelastica", "informational", "Account,Salesforce,delete.log"},
		};
	}
	...
	public Object[][] _1111() {
		return new Object[][]{
			//Activity type  Object Type  Object Name, DestinationDolder  Severity  message
			{ "Delete",    "Contact", "Test Testcase",  "informational", "Contact,Salesforce,delete.log"},
		};
	}
	
	
	
	11 : File,Salesforce,share_wth_link.log
	12 : File,Salesforce,upload.log
	14 : Home,create_new_account.log
	15 : Home,create_new_contact.log
	16 : Home,create_new_document.log
	17 : Home,create_new_event.log
	18 : Home,create_new_file.log
	19 : Home,create_new_link.log
	20 : Home,create_new_log_a_call.log
	21 : Home,create_new_poll.log
	22 : Home,create_new_post.log
	23 : Home,create_new_report.log
	24 : Home,create_new_report1.log
	25 : Home,create_new_task.log
	
	//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "_1069")
	public void verify_User_viewFile_1069(String activityType, String objectType, String severity, String logFile) throws Exception{
		Reporter.log("Validate User viewed Files Page", true);
		String expectedMsg="User viewed Files Page ";
		replayLogs(logFile);
		fsr=fetchElasticSearchLogs(activityType);         		//fetch the logs from ES
		messages=processLogs(fsr);													//Process the messages from logs
		objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
	...
	public Object[][] _1069() {
		return new Object[][]{
			//Activity type  Object Type  Object Name, DestinationDolder  Severity  message
			{ "View",    "FilePage", "informational", "File,Salesforce,view.log"},//file,Salesforce,view.log
			//{ "Upload",    "File", "Test(1)", "AFolder", "informational", "docfile,uploaddoc.log"},//for collab
			//{ "Upload",    "File", "Test(1)", "All Files", "informational"},//for collab
		//	{ "Upload",    "File", "Screen Shot 2015-07-02 at 1.02.20 am.png", "All Files", "informational"}
	...
	public Object[][] _1075() {
		return new Object[][]{
			//Activity type  Object Type  Object Name, DestinationDolder  Severity  message
			{ "Download",    "File", "Test", "informational", "File,Salesforce,download.log"},//file,Salesforce,download.log
			{ "Download",    "File", "Test.c", "informational", "Salesforce,Files,download_Test_c.log"},
			{ "Download",    "File", "Test.java", "informational", "Salesforce,Files,download_Test_java.log"},
			{ "Download",    "File", "Test.js", "informational", "Salesforce,Files,download_Test_js.log"},
			{ "Download",    "File", "Test.mp3", "informational", "Salesforce,Files,download_Test_mp3.log"},
			{ "Download",    "File", "Test.mp4", "informational", "Salesforce,Files,download_Test_mp4.log"},
			{ "Download",    "File", "Test.xls", "informational", "Salesforce,Files,download_Test_xls.log"},
			{ "Download",    "File", "Test.xml", "informational", "Salesforce,Files,download_Test_xml.log"},
		};
	}
	...
	public Object[][] _1093() {
		return new Object[][]{
			//Activity type  Object Type  Object Name,  Severity  message
			{ "Edit",    "Lead", "", "informational", "Lead,Salesforce,edit.log"},
	...
	public void verify_User_editedOpportunity_1120(String activityType, String objectType, String commentText, String severity, String logFile) throws Exception{
		Reporter.log("Validate User edited an Opportunities", true);
		String expectedMsg="User edited an opportunity "+commentText;
		replayLogs(logFile);
		fsr=fetchElasticSearchLogs(activityType);         		//fetch the logs from ES
		messages=processLogs(fsr);													//Process the messages from logs
		objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
	...
	public Object[][] _1120Edited() {
		return new Object[][]{
			//Activity type  Object Type  Object Name,  Severity  message
			{ "Edit",    "Opportunity", "", "informational", "Opportunity,Salesforce,edit.log"},
	...
	public void verify_User_uploadFile_upload(String activityType, String objectType, String commentText, String severity, String logFile) throws Exception{
		Reporter.log("Validate User uploaded the file", true);
		String expectedMsg="User uploaded file named ";
		replayLogs(logFile);
		fsr=fetchElasticSearchLogs(activityType);         		//fetch the logs from ES
		messages=processLogs(fsr);													//Process the messages from logs
		objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
	...
	public void verify_User_uploadFile_share(String activityType, String objectType, String commentText, String severity, String logFile) throws Exception{
		Reporter.log("Validate User shared the file", true);
		String expectedMsg="User shared a file named ";
		replayLogs(logFile);
		fsr=fetchElasticSearchLogs(activityType);         		//fetch the logs from ES
		messages=processLogs(fsr);													//Process the messages from logs
		objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
	...
	public Object[][] _share() {
		return new Object[][]{
			...
			{ "Share",    "File", "Test.mp3", "informational", "Salesforce,Files,share_via_link_internal_Test_mp3.log"},
			{ "Share",    "File", "Test.xls", "informational", "Salesforce,Files,share_via_link_internal_Test_xls.log"},
			{ "Share",    "File", "Test.mp3", "informational", "Salesforce,Files,share_with_groups_internal_Test_mp3.log"},
			{ "Share",    "File", "Test.xml", "informational", "Salesforce,Files,share_with_groups_internal_Test_xml.log"},
			{ "Share",    "File", "Test.xml", "informational", "Salesforce,Files,share_with_people_internal_Test_xml.log"},
			{ "Share",    "File", "Test.xls", "informational", "Salesforce,Files,share_with_people_Test_xls.log"},
	...
	public void verify_User_createHomeAccount_homeAccount(String activityType, String objectType, String commentText, String severity, String logFile) throws Exception{
	...
	public void verify_User_createHomeContact_homeContact(String activityType, String objectType, String commentText, String severity, String logFile) throws Exception{
		Reporter.log("Validate User created the new home contact", true);
		String expectedMsg="User created a new contact with name ";
		replayLogs(logFile);
		fsr=fetchElasticSearchLogs(activityType);         		//fetch the logs from ES
		messages=processLogs(fsr);													//Process the messages from logs
		objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
	...
	public Object[][] _homeContact() {
		return new Object[][]{
			//Activity type  Object Type  Object Name, DestinationDolder  Severity  message
			{ "Create",    "Contact", "Test", "informational", "Home,create_new_contact.log"},
	...
	public void verify_User_createHomeCall_homeCall(String activityType, String objectType, String objectName, String severity, String logFile) throws Exception{
		Reporter.log("Validate User created the new home log a call", true);
		String expectedMsg="User created task (call log) with name "+objectName;
		replayLogs(logFile);
		fsr=fetchElasticSearchLogs(activityType);         		//fetch the logs from ES
		messages=processLogs(fsr);													//Process the messages from logs
		objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
	...
	public Object[][] _homeCall() {
		return new Object[][]{
			//Activity type  Object Type  Object Name, DestinationDolder  Severity  message
			{ "Create",    "Log_A_Call", "Call", "informational", "Home,create_new_log_a_call.log"},
	...
	public void verify_User_createHomePoll_homePoll(String activityType, String objectType, String commentText, String severity, String logFile) throws Exception{
		Reporter.log("Validate User created the new home poll", true);
		String expectedMsg="User created a new poll ";
		replayLogs(logFile);
		fsr=fetchElasticSearchLogs(activityType);         		//fetch the logs from ES
		messages=processLogs(fsr);													//Process the messages from logs
		objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
	...
	public Object[][] _homePoll() {
		return new Object[][]{
			//Activity type  Object Type  Object Name, DestinationDolder  Severity  message
			{ "Create",    "Poll", "", "informational", "Home,create_new_poll.log"},
			
		};
	}
	
	
	@Test(groups ={"TEST", "P1"},dataProvider = "_homePost")/////////
	...
	public void verify_User_createHomeReport_homeReport(String activityType, String objectType, String commentText, String severity, String logFile) throws Exception{
		Reporter.log("Validate User created the new home report", true);
		String expectedMsg="User created a new report ";
		replayLogs(logFile);
		fsr=fetchElasticSearchLogs(activityType);         		//fetch the logs from ES
		messages=processLogs(fsr);													//Process the messages from logs
		objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
	...
	public Object[][] _homeReport() {
		return new Object[][]{
			//Activity type  Object Type  Object Name, DestinationDolder  Severity  message
			{ "Create",    "Report", "", "informational", "Home,create_new_report.log"},
	...
	public void verify_User_createReport_report(String activityType, String objectType, String reportName, String reportType, String severity, String logFile) throws Exception{
		Reporter.log("Validate User created the report", true);
		String expectedMsg="User created a new report "+reportName+" of type "+reportType;
		replayLogs(logFile);
		fsr=fetchElasticSearchLogs(activityType);         		//fetch the logs from ES
		messages=processLogs(fsr);													//Process the messages from logs
		objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
	...
	public Object[][] _reportCreate() {
		return new Object[][]{
			//Activity type  Object Type  Object Name, DestinationDolder  Severity  message
			{ "Create",    "Report", "Unsaved Report", "Leads", "informational", "Report,Salesforce,create.log"}
	...
	public Object[][] _reportEdit() {
		return new Object[][]{
			//Activity type  Object Type  Object Name, DestinationDolder  Severity  message
			{ "Edit",    "Report", "GWAutomation", "informational", "Report,Salesforce,edit.log"},
	...
	public void verify_User_RunReport_report(String activityType, String objectType, String reportName, String severity, String logFile) throws Exception{
		Reporter.log("Validate User created the report", true);
		String expectedMsg="User run a report named "+reportName;
		replayLogs(logFile);
		fsr=fetchElasticSearchLogs(activityType);         		//fetch the logs from ES
		messages=processLogs(fsr);													//Process the messages from logs
		objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
	...
	public void verify_User_ViewChatter_1028(String activityType, String objectType, String reportName, String severity, String logFile) throws Exception{
	...
	public Object[][] _1030() {
		return new Object[][]{
			//Activity type  Object Type  Object Name, DestinationDolder  Severity  message
			{ "Share",    "File", "Hipa.docx", "informational", "file,Salesforce,share_link.log"},
	...
	public Object[][] _1038() {
		return new Object[][]{
			//Activity type  Object Type  Object Name, DestinationDolder  Severity  message
			{ "Social",    "Chatter", "", "informational", "email,Salesforce,chatter_invite.log"},
			
		};
	}
	
	//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "_1039")
	...
	public Object[][] _1039() {
		return new Object[][]{
			//Activity type  Object Type  Object Name, DestinationDolder  Severity  message
			{ "Search",    "Chatter", "search_string", "informational", ""},
	...
	//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "_1040")
		...
		//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "_1041")
				...
				public Object[][] _1041() {
					return new Object[][]{
						//Activity type  Object Type  Object Name, DestinationDolder  Severity  message
						{ "View",    "Chatter", "message", "informational", ""},
				...
				public Object[][] _1079() {
					return new Object[][]{
						//Activity type  Object Type  Object Name, DestinationDolder  Severity  message
						{ "Share", "File", "Test.doc","recp_name", "informational", ""},
						
					};
				}
				
				//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "_1078")
				...
				public void verify_User_ChatterMessageSent_1043(String activityType, String objectType, String message, String recp_name, String severity, String logFile) throws Exception{
					Reporter.log("Validate User sent a message ", true);
					String expectedMsg="User sent a message "+message+" to "+recp_name;
					replayLogs(logFile);
					fsr=fetchElasticSearchLogs(activityType);         		//fetch the logs from ES
					messages=processLogs(fsr);													//Process the messages from logs
					objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
				...
				public Object[][] _1043() {
					return new Object[][]{
						//Activity type  Object Type  Object Name, DestinationDolder  Severity  message
						{ "Social", "Chatter", "message","recp_name", "informational", ""},
				...
				public void verify_User_ChatterMessageReply_1044(String activityType, String objectType, String message, String orig_msg, String severity, String logFile) throws Exception{
					...
					String expectedMsg="User replied with "+message+" to original message "+orig_msg;
					replayLogs(logFile);
					fsr=fetchElasticSearchLogs(activityType);         		//fetch the logs from ES
					messages=processLogs(fsr);													//Process the messages from logs
					objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
				...
				public Object[][] _1044() {
					return new Object[][]{
						//Activity type  Object Type  Object Name, DestinationDolder  Severity  message
						{ "Post", "Comment", "message","orig_msg", "informational", ""},
				...
				public Object[][] _1047() {
					return new Object[][]{
						//Activity type  Object Type  Object Name  Severity  message
						{ "Social", "Chatter", "", "informational", "chatter,Salesforce,comment_like.log"},
				...
				public Object[][] _1048() {
					return new Object[][]{
						//Activity type  Object Type  Object Name  Severity  message
						{ "Social", "Chatter", "", "informational", "chatter,Salesforce,comment_unlike.log"},
			...
			//	@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "_1049")// logs problem we wll rerecorded again
				...
				public Object[][] _1051() {
					return new Object[][]{
						//Activity type  Object Type  Object Name  Severity  message
						{ "Social", "Chatter", "comment_text", "informational", ""},
						
					};
				}
				
				//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "_1053")
				...
				public void verify_User_HomePage_1057(String activityType, String objectType, String severity, String logFile) throws Exception{
					...
					String expectedMsg="User viewed homepage";
					replayLogsWithDelay(logFile);
					fsr=fetchElasticSearchLogs(activityType);         		//fetch the logs from ES
					messages=processLogs(fsr);													//Process the messages from logs
					objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
				...
				public Object[][] _1064() {
					return new Object[][]{
						//Activity type  Object Type  Object Name  Severity  message
						{ "Edit", "Group", "group_name", "informational", ""},
			...
			//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "_1071")logs problem
				...
				//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "_1076")
				...
				public void verify_User_DocumentView_1085(String activityType, String objectType, String object_name, String severity, String logFile) throws Exception{
					Reporter.log("Validate User viewed folder ", true);
					String expectedMsg="User viewed documents "+object_name;
					replayLogs(logFile);
					fsr=fetchElasticSearchLogs(activityType);         		//fetch the logs from ES
					messages=processLogs(fsr);													//Process the messages from logs
					objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
				...
				public Object[][] _1086() {
					return new Object[][]{
						//Activity type  Object Type  Object Name  Severity  message
						{ "Search", "Document","","informational", "document,salesforce,search.log"},
						
					};
				}
				
				@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "_1087")
				...
				public void verify_User_NewDocument_1088(String activityType, String objectType, String doc_name, String file_name, String severity, String logFile) throws Exception{
					Reporter.log("Validate User created a new document named and file name ", true);
					String expectedMsg="User created a new document named "+doc_name+" and file name "+file_name;
					replayLogs(logFile);
					fsr=fetchElasticSearchLogs(activityType);         		//fetch the logs from ES
					messages=processLogs(fsr);													//Process the messages from logs
					objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
				...
				public Object[][] _1088() {
					return new Object[][]{
						//Activity type  Object Type  Object Name  Severity  message
						{ "Create", "Document", "", "", "informational", "document,Salesforce,create.log"},
			...
			//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "_1090")
				...
				public Object[][] _1096() {
					return new Object[][]{
						//Activity type  Object Type  Object Name  Severity  message
						{ "Create", "View","", "informational", "Leads,NewView.log"},
				...
				@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "_1098")
				...
				public Object[][] _1098() {
					return new Object[][]{
						//Activity type  Object Type  Object Name  Severity  message
						{ "Convert", "Lead","", "informational", "Leads,Convert.log"},
				...
				public void verify_User_CampaignsCreate_1200(String activityType, String objectType, String campaign_name, String severity, String logFile) throws Exception{
					...
					String expectedMsg="User craeted a campaign "+campaign_name;
					replayLogs(logFile);
					fsr=fetchElasticSearchLogs(activityType);         		//fetch the logs from ES
					messages=processLogs(fsr);													//Process the messages from logs
					objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
				...
				//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "_1204")
				...
				//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "_1205")
				...
				//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "_1206")
				...
				//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "_1207")
				...
				//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "_1100")
				...
				public Object[][] _1106() {
					return new Object[][]{
						//Activity type  Object Type  Object Name  Severity  message
						{ "Search", "Lead","Test test test","test.com", "informational", "Lead,DuplicateSearch.log"},
				...
				//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "_1143")
				...
				//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "1197") 
				public void verify_User_DataCom_1197(String activityType, String objectType, String severity, String logFile) throws Exception{
					...
					String expectedMsg="User viewed DataCom ";
					replayLogs(logFile);
					fsr=fetchElasticSearchLogs(activityType);         		//fetch the logs from ES
					messages=processLogs(fsr);													//Process the messages from logs
					objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
				...
				public Object[][] _1197() {
					return new Object[][]{
						//Activity type  Object Type  Object Name  Severity  message
						{ "View", "DataCom", "informational", ""},
						
					};
				}
				
				//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "1198") 
				public void verify_User_DataComSearch_1198(String activityType, String objectType, String search, String severity, String logFile) throws Exception{
					...
					String expectedMsg="User searched "+search+" in DataCom ";
					replayLogs(logFile);
					fsr=fetchElasticSearchLogs(activityType);         		//fetch the logs from ES
					messages=processLogs(fsr);													//Process the messages from logs
					objectNameList=processLogsObjectNames(fsr);                                 //Process the object Names from logs
				...
				//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "1219") 
				...
				//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "1237") 
				...
				public Object[][] _1237() {
					return new Object[][]{
						//Activity type  Object Type  Object Name  Severity  message
						{ "View", "Solution", "informational", ""},
						
					};
				}
				
				//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "1238") 
				...
				public Object[][] _1238() {
					return new Object[][]{
						//Activity type  Object Type  Object Name  Severity  message
						{ "Create", "Solutions","","", "informational", ""},
						
					};
				}
				
				//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "1239") 
				...
				//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "1240") 
				...
				public Object[][] _1240() {
					return new Object[][]{
						//Activity type  Object Type  Object Name  Severity  message
						{ "Edit", "Solution","", "informational", ""},
						
					};
				}
				
				//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "1242") 
				...
				public Object[][] _1242() {
					return new Object[][]{
						//Activity type  Object Type  Object Name  Severity  message
						{ "Search", "Solution","", "informational", ""},
						
					};
				}
				
				//@Test(groups ={"TEST","BOX", "UPLOAD", "QAVPC","P1"},dataProvider = "1243") 
