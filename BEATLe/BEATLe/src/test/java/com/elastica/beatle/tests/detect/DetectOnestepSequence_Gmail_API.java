...
public class DetectOnestepSequence_Gmail_API extends  DetectUtils {
...
private static String UserRecieved ;
	...
	public Object[][] AddEditDeleteDataProvider() throws JAXBException, Exception  {
		...
		String[] activitiesReceive = new String[]{"Receive"};
		String[] activitiesSend = new String[]{"Send"};
		
		String[] activitiesDelete = new String[]{"Delete"};
		
		String[] activitiesRemove = new String[]{"Remove"};
		...
		SDInput sdInput = dsd.createSDInput(SequenceDetectorConstants.SEND, 2,400, false   ,false, false,
				activitiesSend, failities, sources, users, objects);
		HttpResponse response = dsd.createSequenceDetector(sdInput, suiteData);
		
		 sdInput = dsd.createSDInput(SequenceDetectorConstants.SEND_ONE, 2,600, true   ,true, true,
				 activitiesSend, failities1, sources1, users1, objects1);
			 response = dsd.createSequenceDetector(sdInput, suiteData);
			
			sdInput = dsd.createSDInput(SequenceDetectorConstants.SEND_TWO, 1,400, false   ,false, false,
					activitiesSend, failities, sources1, users, objects1);
			 response = dsd.createSequenceDetector(sdInput, suiteData);
			
			sdInput = dsd.createSDInput(SequenceDetectorConstants.SEND_THREE, 1,400, true  ,true, true,
					activitiesSend, failities1, sources1, users, objects1);
			 response = dsd.createSequenceDetector(sdInput, suiteData);
			 
			  sdInput = dsd.createSDInput(SequenceDetectorConstants.CREATE, 2,400, false   ,false, false,
				 ...
				 sdInput = dsd.createSDInput(SequenceDetectorConstants.CREATE_TWO, 2,600, true   ,true, true,
					...
					sdInput = dsd.createSDInput(SequenceDetectorConstants.CREATE_FOUR, 1,400, true  ,true, true,
					 ...
					 sdInput = dsd.createSDInput(SequenceDetectorConstants.RECEIVE, 2,400, false   ,false, false,
							 activitiesReceive, failities, sources, userrecieved, objects);
						 response = dsd.createSequenceDetector(sdInput, suiteData);
						
						 sdInput = dsd.createSDInput(SequenceDetectorConstants.RECEIVE_TWO, 2,600, true   ,true, true,
								 activitiesReceive, failities1, sources1, userrecieved, objects1);
							 response = dsd.createSequenceDetector(sdInput, suiteData);
							
							sdInput = dsd.createSDInput(SequenceDetectorConstants.RECEIVE_THREE, 1,400, false   ,false, false,
									activitiesReceive, failities, sources1, userrecieved, objects1);
							 response = dsd.createSequenceDetector(sdInput, suiteData);
							
							sdInput = dsd.createSDInput(SequenceDetectorConstants.RECEIVE_ONE, 1,400, true  ,true, true,
									activitiesReceive, failities1, sources1, userrecieved, objects1);
							 response = dsd.createSequenceDetector(sdInput, suiteData);
		...
		return new Object[][]{
			...
			{ SequenceDetectorConstants.SEND},
			{ SequenceDetectorConstants.SEND_ONE},
			{ SequenceDetectorConstants.SEND_TWO},
			{ SequenceDetectorConstants.SEND_THREE},
			...
			{ SequenceDetectorConstants.RECEIVE},
			{ SequenceDetectorConstants.RECEIVE_TWO},
			{ SequenceDetectorConstants.RECEIVE_THREE},
			{ SequenceDetectorConstants.RECEIVE_ONE},
	...
	public void addCreateDeleteemailSDTest(Method method, String name) throws Exception{
