 ...
 *
 */
public class AuditWebUploadb2zFactory2{
	...
	public Object[] WebUploadFactoryMethod(){
		return new Object[]{
				...
				new AuditWeeklyRegressionWebUploadTests(AuditWeeklyRegressionConstants.BLUECOAT_PROXY_CUSTOM_HEADER_QUOTE_HEADER_BZ2),
				new AuditWeeklyRegressionWebUploadTests(AuditWeeklyRegressionConstants.BLUECOAT_PROXY_CUSTOM_HEADER_SPACE_HEADER_BZ2),			
