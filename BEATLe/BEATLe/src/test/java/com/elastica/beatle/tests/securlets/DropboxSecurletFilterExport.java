...
public class DropboxSecurletFilterExport extends SecurletUtils{
	...
	String appName = "Dropbox";

	public DropboxSecurletFilterExport() throws Exception {
	...
	@Test(groups={"EXPORT", "DROPBOX", "REGRESSION", "P1"})
	public void csvExportOfExposedFilesWithDefaultDashBoard() throws Exception {
		...
		String query = "Dropbox Securlet Data Export";
		String expectedAttachment = "Dropbox_securlet_docs_" + DateUtils.getCurrentDate();
	...
	@Test(dataProviderClass = SalesforceDataProvider.class, dataProvider = "ExportFilter", groups={"EXPORT", "DROPBOX", "REGRESSION", "P1"})
	...
	@Test(dataProviderClass = SalesforceDataProvider.class, dataProvider = "ExportUsersFilter", groups={"EXPORT", "DROPBOX", "REGRESSION", "P1"})
	public void checkCSVExportOfExposedUsersWithFilters(String exposureType, String objectType, 
		...
		if (exportType.equals("users")) {
			expectedAttachment = "Dropbox_securlet_users_" + DateUtils.getCurrentDate();
		} else if( exportType.equals("ext_collabs")) {
			expectedAttachment = "Dropbox_securlet_ext_collabs_" + DateUtils.getCurrentDate();
		}
		...
		docparams.add(new BasicNameValuePair(SecurletsConstants.APP, "Dropbox"));
		...
		if (exportType.equals("users")) {
			exposedUsers = getExposedUsers(elapp.el_dropbox.name(), docparams);
		} else if( exportType.equals("ext_collabs")) {
			exposedUsers = getCollaborators(elapp.el_dropbox.name(), docparams);
		}
	...
	@Test(dataProviderClass = SalesforceDataProvider.class, dataProvider = "RiskyFilesFilter", groups={"EXPORT", "DROPBOX", "REGRESSION", "P1"})
	public void csvExportOfRiskyFilesWithFilters(String exposureType, String objectType, 
		...
		String expectedAttachment = "Dropbox_securlet_risky_docs_" + DateUtils.getCurrentDate();
