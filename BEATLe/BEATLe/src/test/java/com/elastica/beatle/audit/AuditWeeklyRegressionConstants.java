 ...
 *
 */
public class AuditWeeklyRegressionConstants {
	
	
	// Added By Laxman Start 
	
	 	//FIREWALL_BE_BARRACUDA_SYS -1
	
		public static final String FIREWALL_BE_BARRACUDA_SYS_ZIP = "audit_weekly_be_barracuda_sys_zip";
	    public static final String FIREWALL_BE_BARRACUDA_SYS_GZ = "audit_weekly_be_barracuda_sys_gz";
	    public static final String FIREWALL_BE_BARRACUDA_SYS_BZ2 = "audit_weekly_be_barracuda_sys_bz2";
	    public static final String FIREWALL_BE_BARRACUDA_SYS_7Z = "audit_weekly_be_barracuda_sys_7z";
	    public static final String FIREWALL_BE_BARRACUDA_SYS_7ZA = "audit_weekly_be_barracuda_sys_7za";
	    
	    //FIREWALL_BE_BLUECOAT_PROXY -2
	    
	    public static final String FIREWALL_BE_BLUECOAT_PROXY_ZIP = "audit_weekly_be_bluecoat_proxy_zip";
	    public static final String FIREWALL_BE_BLUECOAT_PROXY_GZ = "audit_weekly_be_bluecoat_proxy_gz";
	    public static final String FIREWALL_BE_BLUECOAT_PROXY_BZ2 = "audit_weekly_be_bluecoat_proxy_bz2";
	    public static final String FIREWALL_BE_BLUECOAT_PROXY_7Z = "audit_weekly_be_bluecoat_proxy_7z";
	    public static final String FIREWALL_BE_BLUECOAT_PROXY_7ZA = "audit_weekly_be_bluecoat_proxy_7za";
	    
	    //FIREWALL_BE_BLUECOATPROXY_SPLUNK_WO_CH -3
	    
	    public static final String FIREWALL_BE_BLUECOATPROXY_SPLUNK_WO_CH_ZIP = "audit_weekly_be_bluecoatProxy_splunk_wo_ch_zip";
	    public static final String FIREWALL_BE_BLUECOATPROXY_SPLUNK_WO_CH_GZ = "audit_weekly_be_bluecoatProxy_splunk_wo_ch_gz";
	    public static final String FIREWALL_BE_BLUECOATPROXY_SPLUNK_WO_CH_BZ2 = "audit_weekly_be_bluecoatProxy_splunk_wo_ch_bz2";
	    public static final String FIREWALL_BE_BLUECOATPROXY_SPLUNK_WO_CH_7Z = "audit_weekly_be_bluecoatProxy_splunk_wo_ch_7z";
	    public static final String FIREWALL_BE_BLUECOATPROXY_SPLUNK_WO_CH_7ZA = "audit_weekly_be_bluecoatProxy_splunk_wo_ch_7za";
	
	    //FIREWALL_CHECKPOINT_CSV -4
	    
	    public static final String FIREWALL_CHECKPOINT_CSV_ZIP = "audit_weekly_be_checkpoint_csv_zip";
	    public static final String FIREWALL_CHECKPOINT_CSV_GZ = "audit_weekly_be_checkpoint_csv_gz";
	    public static final String FIREWALL_CHECKPOINT_CSV_BZ2 = "audit_weekly_be_checkpoint_csv_bz2";
	    public static final String FIREWALL_CHECKPOINT_CSV_7Z = "audit_weekly_be_checkpoint_csv_7z";
	    public static final String FIREWALL_CHECKPOINT_CSV_7ZA = "audit_weekly_be_checkpoint_csv_7za";
	
	    //FIREWALL_BE_CHECKPOINT_SMARTVIEW -5
	    
	    public static final String FIREWALL_BE_CHECKPOINT_SMARTVIEW_ZIP = "audit_weekly_be_checkpoint_smartview_zip";
	    public static final String FIREWALL_BE_CHECKPOINT_SMARTVIEW_GZ = "audit_weekly_be_checkpoint_smartview_gz";
	    public static final String FIREWALL_BE_CHECKPOINT_SMARTVIEW_BZ2 = "audit_weekly_be_checkpoint_smartview_bz2";
	    public static final String FIREWALL_BE_CHECKPOINT_SMARTVIEW_7Z = "audit_weekly_be_checkpoint_smartview_7z";
	    public static final String FIREWALL_BE_CHECKPOINT_SMARTVIEW_7ZA = "audit_weekly_be_checkpoint_smartview_7za";
	    
	    //FIREWALL_BE_JUNIPER_SCREENOS -6
	    
	    public static final String FIREWALL_BE_JUNIPER_SCREENOS_ZIP = "audit_weekly_be_juniper_screenos_zip";
	    public static final String FIREWALL_BE_JUNIPER_SCREENOS_GZ = "audit_weekly_be_juniper_screenos_gz";
	    public static final String FIREWALL_BE_JUNIPER_SCREENOS_BZ2 = "audit_weekly_be_juniper_screenos_bz2";
	    public static final String FIREWALL_BE_JUNIPER_SCREENOS_7Z = "audit_weekly_be_juniper_screenos_7z";
	    public static final String FIREWALL_BE_JUNIPER_SCREENOS_7ZA = "audit_weekly_be_juniper_screenos_7za";
	    
	    //FIREWALL_MCAFEE_SEF -7
	    
	    public static final String FIREWALL_MCAFEE_SEF_ZIP = "audit_weekly_be_mcafee_sef_zip";
	    public static final String FIREWALL_MCAFEE_SEF_GZ = "audit_weekly_be_mcafee_sef_gz";
	    public static final String FIREWALL_MCAFEE_SEF_BZ2 = "audit_weekly_be_mcafee_sef_bz2";
	    public static final String FIREWALL_MCAFEE_SEF_7Z = "audit_weekly_be_mcafee_sef_7z";
	    public static final String FIREWALL_MCAFEE_SEF_7ZA = "audit_weekly_be_mcafee_sef_7za";
	    
	    //FIREWALL_BE_PANCSV -8
	    
	    public static final String FIREWALL_BE_PANCSV_ZIP = "audit_weekly_be_pancsv_zip";
	    public static final String FIREWALL_BE_PANCSV_GZ = "audit_weekly_be_pancsv_gz";
	    public static final String FIREWALL_BE_PANCSV_BZ2 = "audit_weekly_be_pancsv_bz2";
	    public static final String FIREWALL_BE_PANCSV_7Z = "audit_weekly_be_pancsv_7z";
	    public static final String FIREWALL_BE_PANCSV_7ZA = "audit_weekly_be_pancsv_7za";
	    
	    //FIREWALL_BE_PANCSV_SPLUNK_WO_CH -9
	    
	    public static final String FIREWALL_BE_PANCSV_SPLUNK_WO_CH_ZIP = "audit_weekly_be_pancsv_splunk_wo_ch_zip";
	    public static final String FIREWALL_BE_PANCSV_SPLUNK_WO_CH_GZ = "audit_weekly_be_pancsv_splunk_wo_ch_gz";
	    public static final String FIREWALL_BE_PANCSV_SPLUNK_WO_CH_BZ2 = "audit_weekly_be_pancsv_splunk_wo_ch_bz2";
	    public static final String FIREWALL_BE_PANCSV_SPLUNK_WO_CH_7Z = "audit_weekly_be_pancsv_splunk_wo_ch_7z";
	    public static final String FIREWALL_BE_PANCSV_SPLUNK_WO_CH_7ZA = "audit_weekly_be_pancsv_splunk_wo_ch_7za";
	
	    //FIREWALL_SQUID_PROXY -10
	    
	    public static final String FIREWALL_SQUID_PROXY_ZIP = "audit_weekly_be_squid_proxy_zip";
	    public static final String FIREWALL_SQUID_PROXY_GZ = "audit_weekly_be_squid_proxy_gz";
	    public static final String FIREWALL_SQUID_PROXY_BZ2 = "audit_weekly_be_squid_proxy_bz2";
	    public static final String FIREWALL_SQUID_PROXY_7Z = "audit_weekly_be_squid_proxy_7z";
	    public static final String FIREWALL_SQUID_PROXY_7ZA = "audit_weekly_be_squid_proxy_7za";
	    
	    //FIREWALL_BE_WSAW3C -11
	    
	    public static final String FIREWALL_BE_WSAW3C_ZIP = "audit_weekly_be_wsaw3c_zip";
	    public static final String FIREWALL_BE_WSAW3C_GZ = "audit_weekly_be_wsaw3c_gz";
	    public static final String FIREWALL_BE_WSAW3C_BZ2 = "audit_weekly_be_wsaw3c_bz2";
	    public static final String FIREWALL_BE_WSAW3C_7Z = "audit_weekly_be_wsaw3c_7z";
	    public static final String FIREWALL_BE_WSAW3C_7ZA = "audit_weekly_be_wsaw3c_7za";
	    
	    //FIREWALL_BE_WSA_ACCESS -12
	    
	    public static final String FIREWALL_BE_WSA_ACCESS_ZIP = "audit_weekly_be_wsa_access_zip";
	    public static final String FIREWALL_BE_WSA_ACCESS_GZ = "audit_weekly_be_wsa_access_gz";
	    public static final String FIREWALL_BE_WSA_ACCESS_BZ2 = "audit_weekly_be_wsa_access_bz2";
	    public static final String FIREWALL_BE_WSA_ACCESS_7Z = "audit_weekly_be_wsa_access_7z";
	    public static final String FIREWALL_BE_WSA_ACCESS_7ZA = "audit_weekly_be_wsa_access_7za";
	    
	    //FIREWALL_BE_ZSCALAR -13
	    
	    public static final String FIREWALL_BE_ZSCALAR_ZIP = "audit_weekly_be_zscalar_zip";
	    public static final String FIREWALL_BE_ZSCALAR_GZ = "audit_weekly_be_zscalar_gz";
	    public static final String FIREWALL_BE_ZSCALAR_BZ2 = "audit_weekly_be_zscalar_bz2";
	    public static final String FIREWALL_BE_ZSCALAR_7Z = "audit_weekly_be_zscalar_7z";
	    public static final String FIREWALL_BE_ZSCALAR_7ZA = "audit_weekly_be_zscalar_7za";
	
	    //FIREWALL_JUNIPER_SRX -14
	    
	    public static final String FIREWALL_JUNIPER_SRX_ZIP = "audit_weekly_be_juniper_srx_zip";
	    public static final String FIREWALL_JUNIPER_SRX_GZ = "audit_weekly_be_juniper_srx_gz";
	    public static final String FIREWALL_JUNIPER_SRX_BZ2 = "audit_weekly_be_juniper_srx_bz2";
	    public static final String FIREWALL_JUNIPER_SRX_7Z = "audit_weekly_be_juniper_srx_7z";
	    public static final String FIREWALL_JUNIPER_SRX_7ZA = "audit_weekly_be_juniper_srx_7za";
	    
	    
	    //FIREWALL_SCANSAFE -15
	    
	    public static final String FIREWALL_SCANSAFE_ZIP = "audit_weekly_be_scansafe_zip";
	    public static final String FIREWALL_SCANSAFE_GZ = "audit_weekly_be_scansafe_gz";
	    public static final String FIREWALL_SCANSAFE_BZ2 = "audit_weekly_be_scansafe_bz2";
	    public static final String FIREWALL_SCANSAFE_7Z = "audit_weekly_be_scansafe_7z";
	    public static final String FIREWALL_SCANSAFE_7ZA = "audit_weekly_be_scansafe_7za";
	    
	    //FIREWALL_CISCO_ASA_SERIES -16
	    
	    public static final String FIREWALL_CISCO_ASA_SERIES_ZIP = "audit_weekly_be_cisco_asa_series_zip";
	    public static final String FIREWALL_CISCO_ASA_SERIES_GZ = "audit_weekly_be_cisco_asa_series_gz";
	    public static final String FIREWALL_CISCO_ASA_SERIES_BZ2 = "audit_weekly_be_cisco_asa_series_bz2";
	    public static final String FIREWALL_CISCO_ASA_SERIES_7Z = "audit_weekly_be_cisco_asa_series_7z";
	    public static final String FIREWALL_CISCO_ASA_SERIES_7ZA = "audit_weekly_be_cisco_asa_series_7za";
	    
	    //FIREWALL_WEBSENSE_ARC -17
	    
	    public static final String FIREWALL_WEBSENSE_ARC_ZIP = "audit_weekly_be_websense_arc_zip";
	    public static final String FIREWALL_WEBSENSE_ARC_GZ = "audit_weekly_be_websense_arc_gz";
	    public static final String FIREWALL_WEBSENSE_ARC_BZ2 = "audit_weekly_be_websense_arc_bz2";
	    public static final String FIREWALL_WEBSENSE_ARC_7Z = "audit_weekly_be_websense_arc_7z";
	    public static final String FIREWALL_WEBSENSE_ARC_7ZA = "audit_weekly_be_websense_arc_7za";
	    
	    //FIREWALL_SONICWALL -18
	    
	    public static final String FIREWALL_SONICWALL_ZIP = "audit_weekly_be_sonicwall_zip";
	    public static final String FIREWALL_SONICWALL_GZ = "audit_weekly_be_sonicwall_gz";
	    public static final String FIREWALL_SONICWALL_BZ2 = "audit_weekly_be_sonicwall_bz2";
	    public static final String FIREWALL_SONICWALL_7Z = "audit_weekly_be_sonicwall_7z";
	    public static final String FIREWALL_SONICWALL_7ZA = "audit_weekly_be_sonicwall_7za";
 
	    //FIREWALL_WEBSENSE_HOSTED -19
	    
	    public static final String FIREWALL_WEBSENSE_HOSTED_ZIP = "audit_weekly_be_websence_hosted_zip";
	    public static final String FIREWALL_WEBSENSE_HOSTED_GZ = "audit_weekly_be_websence_hosted_gz";
	    public static final String FIREWALL_WEBSENSE_HOSTED_BZ2 = "audit_weekly_be_websence_hosted_bz2";
	    public static final String FIREWALL_WEBSENSE_HOSTED_7Z = "audit_weekly_be_websence_hosted_7z";
	    public static final String FIREWALL_WEBSENSE_HOSTED_7ZA = "audit_weekly_be_websence_hosted_7za";
	    
	    //bluecoat_proxy_custom_header_quote_header -20
	    
	    public static final String BLUECOAT_PROXY_CUSTOM_HEADER_QUOTE_HEADER_ZIP = "audit_weekly_be_bluecoat_proxy_custom_header_space_escape_zip";
	    public static final String BLUECOAT_PROXY_CUSTOM_HEADER_QUOTE_HEADER_GZ = "audit_weekly_be_bluecoat_proxy_custom_header_space_escape_gz";
	    public static final String BLUECOAT_PROXY_CUSTOM_HEADER_QUOTE_HEADER_BZ2 = "audit_weekly_be_bluecoat_proxy_custom_header_space_escape_bz2";
	    public static final String BLUECOAT_PROXY_CUSTOM_HEADER_QUOTE_HEADER_7Z = "audit_weekly_be_bluecoat_proxy_custom_header_space_escape_7z";
	    public static final String BLUECOAT_PROXY_CUSTOM_HEADER_QUOTE_HEADER_7ZA = "audit_weekly_be_bluecoat_proxy_custom_header_space_escape_7za";
	    
	    //bluecoat_proxy_custom_header_space_escape -21
	    
	    public static final String BLUECOAT_PROXY_CUSTOM_HEADER_SPACE_HEADER_ZIP = "audit_weekly_be_bluecoat_proxy_custom_header_quote_header_zip";
	    public static final String BLUECOAT_PROXY_CUSTOM_HEADER_SPACE_HEADER_GZ = "audit_weekly_be_bluecoat_proxy_custom_header_quote_header_gz";
	    public static final String BLUECOAT_PROXY_CUSTOM_HEADER_SPACE_HEADER_BZ2 = "audit_weekly_be_bluecoat_proxy_custom_header_quote_header_bz2";
	    public static final String BLUECOAT_PROXY_CUSTOM_HEADER_SPACE_HEADER_7Z = "audit_weekly_be_bluecoat_proxy_custom_header_quote_header_7z";
	    public static final String BLUECOAT_PROXY_CUSTOM_HEADER_SPACE_HEADER_7ZA = "audit_weekly_be_bluecoat_proxy_custom_header_quote_header_7za";
...
//
//
//	public static final String FIREWALL_BE_BARRACUDA_CLI = "audit_weekly_be_barracuda_cli";
//	public static final String BE_BARRACUDA_CLI_DATA_SHEET="audit_weekly_be_barracuda_cli";
//	
//	public static final String FIREWALL_BE_BARRACUDA_SYS = "audit_weekly_be_barracuda_sys";
//	public static final String BE_BARRACUDA_SYS_DATA_SHEET="audit_weekly_be_barracuda_sys";
//	
//	public static final String FIREWALL_BE_BLUECOAT_PROXY = "audit_weekly_be_bluecoat_proxy";
//	public static final String BE_BLUECOAT_PROXY_DATA_SHEET="audit_weekly_be_bluecoat_proxy";
//	
//
//	public static final String FIREWALL_BE_BLUECOATPROXY_SPLUNK_WO_CH = "audit_weekly_be_bluecoatProxy_splunk_wo_ch";
//	public static final String BE_BLUECOATPROXY_SPLUNK_WO_CH_DATA_SHEET = "audit_weekly_be_bluecoatProxy_splunk_wo_ch";
//	
//	public static final String FIREWALL_BE_BLUECOATPROXY_SPLUNK_MANDATORY_HEADERS = "audit_weekly_be_bluecoatProxy_splunk_mandatory_headers";
//	//public static final String BE_BLUECOATPROXY_SPLUNK_WO_CH_DATA_SHEET = "audit_weekly_be_bluecoatProxy_splunk_wo_ch";
//	
//	
//	
//	
//	public static final String FIREWALL_BE_CHECKPOINT_CSV = "audit_weekly_be_checkpoint_csv";
//	public static final String BE_CHECKPOINT_CSV_DATA_SHEET="audit_weekly_be_checkpoint_csv";
//	
//	
//	public static final String FIREWALL_BE_CHECKPOINT_SMARTVIEW = "audit_weekly_be_checkpoint_smartview";
//	public static final String BE_CHECKPOINT_SMARTVIEW_DATA_SHEET="audit_weekly_be_checkpoint_smartview";
//	
//	public static final String FIREWALL_BE_JUNIPER_SCREENOS = "audit_weekly_be_juniperscreenos";
//	public static final String BE_JUNIPER_SCREENOS_DATA_SHEET = "audit_weekly_be_juniperscreenos";
//	
...
//	
//	
//	public static final String FIREWALL_BE_PANCSV = "audit_weekly_be_pancsv";
//	public static final String BE_PANCSV_DATA_SHEET = "audit_weekly_be_pancsv";
//	
//	public static final String FIREWALL_BE_PANCSV_SPLUNK_WO_CH = "audit_weekly_be_pancsv_splunk_wo_ch";
//	public static final String BE_PANCSV_SPLUNK_WO_CH_DATA_SHEET = "audit_weekly_be_pancsv_splunk_wo_ch";
//	
//	public static final String FIREWALL_BE_PANCSV_SPLUNK_CH = "audit_weekly_be_pancsv_splunk_ch";
//	public static final String BE_PANCSV_SPLUNK_CH_DATA_SHEET = "audit_weekly_be_pancsv_splunk_ch";
//	
//	
//	public static final String FIREWALL_BE_WSAW3C = "audit_weekly_be_wsaw3c";
//	public static final String BE_WSAW3C_DATA_SHEET = "audit_weekly_be_wsaw3c";
//	
//	public static final String FIREWALL_BE_WSA_ACCESS = "audit_weekly_be_wsaaccess";
//	public static final String BE_WSA_ACCESS_DATA_SHEET = "audit_weekly_be_wsaaccess";
//	
//	public static final String FIREWALL_BE_ZSCALAR = "audit_weekly_be_zscalar";
//	public static final String BE_ZSCALAR_DATA_SHEET = "audit_weekly_be_zscalar";
//
//
//	//empty log files
...
//	public static final String TIA_FIREWALL_MCA2_USER="UserTIA03";
//	
...
//	
//	//7z format constants
//	public static final String FIREWALL_BE_BARRACUDA_CLI_7Z = "audit_weekly_be_barracuda_cli_7z";
//	public static final String BE_BARRACUDA_CLI_DATA_SHEET_7Z="audit_weekly_be_barracuda_cli";
//	
//	public static final String FIREWALL_BE_BARRACUDA_SYS_7Z = "audit_weekly_be_barracuda_sys_7z";
//	public static final String BE_BARRACUDA_SYS_DATA_SHEET_7Z="audit_weekly_be_barracuda_sys";
//	
//	public static final String FIREWALL_BE_BLUECOAT_PROXY_7Z = "audit_weekly_be_bluecoat_proxy_7z";
//	public static final String FIREWALL_BE_BLUECOAT_PROXY_BZ2 = "audit_weekly_be_bluecoat_proxy_bz2";
//	public static final String FIREWALL_BE_BLUECOAT_PROXY_GZ = "audit_weekly_be_bluecoat_proxy_gz";
//	public static final String BE_BLUECOAT_PROXY_DATA_SHEET_7Z="audit_weekly_be_bluecoat_proxy";
//	
//	public static final String FIREWALL_BE_BLUECOATPROXY_SPLUNK_WO_CH_7Z = "audit_weekly_be_bluecoatProxy_splunk_wo_ch_7z";
//	public static final String BE_BLUECOATPROXY_SPLUNK_WO_CH_DATA_SHEET_7Z = "audit_weekly_be_bluecoatProxy_splunk_wo_ch";
//	
//	
//	public static final String FIREWALL_BE_CHECKPOINT_CSV_7Z = "audit_weekly_be_checkpoint_csv_7z";
//	public static final String BE_CHECKPOINT_CSV_DATA_SHEET_7Z="audit_weekly_be_checkpoint_csv";
//	
//	
//	public static final String FIREWALL_BE_CHECKPOINT_SMARTVIEW_7Z = "audit_weekly_be_checkpoint_smartview_7z";
//	public static final String BE_CHECKPOINT_SMARTVIEW_DATA_SHEET_7Z="audit_weekly_be_checkpoint_smartview";
//	
//	public static final String FIREWALL_BE_JUNIPER_SCREENOS_7Z = "audit_weekly_be_juniperscreenos_7z";
//	public static final String BE_JUNIPER_SCREENOS_DATA_SHEET_7Z = "audit_weekly_be_juniperscreenos";
//	
...
//	public static final String FIREWALL_BE_PANCSV_GZ = "audit_weekly_be_pancsv_gz";
//	
//	public static final String BE_PANCSV_DATA_SHEET_7Z = "audit_weekly_be_pancsv";
//	
//	public static final String FIREWALL_BE_PANCSV_SPLUNK_WO_CH_7Z = "audit_weekly_be_pancsv_splunk_wo_ch_7z";
//	public static final String BE_PANCSV_SPLUNK_WO_CH_DATA_SHEET_7Z = "audit_weekly_be_pancsv_splunk_wo_ch";
//	
//	public static final String FIREWALL_BE_PANCSV_SPLUNK_CH_7Z = "audit_weekly_be_pancsv_splunk_ch_7z";
//	public static final String BE_PANCSV_SPLUNK_CH_DATA_SHEET_7Z = "audit_weekly_be_pancsv_splunk_ch";
//	
//	
//	public static final String FIREWALL_BE_WSAW3C_7Z = "audit_weekly_be_wsaw3c_7z";
//	public static final String FIREWALL_BE_WSAW3C_BZ2 = "audit_weekly_be_wsaw3c_bz2";
//	public static final String FIREWALL_BE_WSAW3C_GZ = "audit_weekly_be_wsaw3c_gz";
//	
//	public static final String BE_WSAW3C_DATA_SHEET_7Z = "audit_weekly_be_wsaw3c";
//	
//	public static final String FIREWALL_BE_WSA_ACCESS_7Z = "audit_weekly_be_wsaaccess_7z";
//	public static final String BE_WSA_ACCESS_DATA_SHEET_7Z = "audit_weekly_be_wsaaccess";
//	
//	public static final String FIREWALL_BE_ZSCALAR_7Z = "audit_weekly_be_zscalar_7z";
//	public static final String FIREWALL_BE_ZSCALAR_BZ2 = "audit_weekly_be_zscalar_bz2";
//	public static final String FIREWALL_BE_ZSCALAR_GZ = "audit_weekly_be_zscalar_gz";
//	
//	public static final String BE_ZSCALAR_DATA_SHEET_7Z = "audit_weekly_be_zscalar";
//	
...
//
//	//7za formats
//	public static final String FIREWALL_BE_BARRACUDA_CLI_7ZA = "audit_weekly_be_barracuda_cli_7za";
//	public static final String BE_BARRACUDA_CLI_DATA_SHEET_7ZA="audit_weekly_be_barracuda_cli";
//	
//	public static final String FIREWALL_BE_BARRACUDA_SYS_7ZA = "audit_weekly_be_barracuda_sys_7za";
//	public static final String BE_BARRACUDA_SYS_DATA_SHEET_7ZA="audit_weekly_be_barracuda_sys";
//	
//	public static final String FIREWALL_BE_BLUECOAT_PROXY_7ZA = "audit_weekly_be_bluecoat_proxy_7za";
//	public static final String BE_BLUECOAT_PROXY_DATA_SHEET_7ZA="audit_weekly_be_bluecoat_proxy";
//	
//	public static final String FIREWALL_BE_BLUECOATPROXY_SPLUNK_WO_CH_7ZA = "audit_weekly_be_bluecoatProxy_splunk_wo_ch_7za";
//	public static final String BE_BLUECOATPROXY_SPLUNK_WO_CH_DATA_SHEET_7ZA = "audit_weekly_be_bluecoatProxy_splunk_wo_ch";
//	
//	
//	public static final String FIREWALL_BE_CHECKPOINT_CSV_7ZA = "audit_weekly_be_checkpoint_csv_7za";
//	public static final String BE_CHECKPOINT_CSV_DATA_SHEET_7ZA="audit_weekly_be_checkpoint_csv";
//	
//	
//	public static final String FIREWALL_BE_CHECKPOINT_SMARTVIEW_7ZA = "audit_weekly_be_checkpoint_smartview_7za";
//	public static final String BE_CHECKPOINT_SMARTVIEW_DATA_SHEET_7ZA="audit_weekly_be_checkpoint_smartview";
//	
//	public static final String FIREWALL_BE_JUNIPER_SCREENOS_7ZA = "audit_weekly_be_juniperscreenos_7za";
//	public static final String BE_JUNIPER_SCREENOS_DATA_SHEET_7ZA = "audit_weekly_be_juniperscreenos";
//	
...
//	
//	public static final String FIREWALL_BE_PANCSV_7ZA = "audit_weekly_be_pancsv_7za";
//	public static final String BE_PANCSV_DATA_SHEET_7ZA = "audit_weekly_be_pancsv";
//	
//	public static final String FIREWALL_BE_PANCSV_SPLUNK_WO_CH_7ZA = "audit_weekly_be_pancsv_splunk_wo_ch_7za";
//	public static final String BE_PANCSV_SPLUNK_WO_CH_DATA_SHEET_7ZA = "audit_weekly_be_pancsv_splunk_wo_ch";
//	
//	public static final String FIREWALL_BE_PANCSV_SPLUNK_CH_7ZA = "audit_weekly_be_pancsv_splunk_ch_7za";
//	public static final String BE_PANCSV_SPLUNK_CH_DATA_SHEET_7ZA = "audit_weekly_be_pancsv_splunk_ch";
//	
//	
//	public static final String FIREWALL_BE_WSAW3C_7ZA = "audit_weekly_be_wsaw3c_7za";
//	public static final String BE_WSAW3C_DATA_SHEET_7ZA = "audit_weekly_be_wsaw3c";
//	
//	public static final String FIREWALL_BE_WSA_ACCESS_7ZA = "audit_weekly_be_wsaaccess_7za";
//	public static final String BE_WSA_ACCESS_DATA_SHEET_7ZA = "audit_weekly_be_wsaaccess";
//	
//	public static final String FIREWALL_BE_ZSCALAR_7ZA = "audit_weekly_be_zscalar_7za";
//	public static final String BE_ZSCALAR_DATA_SHEET_7ZA = "audit_weekly_be_zscalar";
//	
...
//
//		firewallLogsList.add(AuditWeeklyRegressionConstants.FIREWALL_WALLMART_PAN_CSV);
//		firewallLogsList.add(AuditWeeklyRegressionConstants.FIREWALL_WALLMART_PAN_SYS);
//		firewallLogsList.add(AuditWeeklyRegressionConstants.FIREWALL_WALLMART_MCAFEE_WEB_GATEWAY);
//		firewallLogsList.add(AuditWeeklyRegressionConstants.FIREWALL_BLUECOAT_PROXYSG);
//		firewallLogsList.add(AuditWeeklyRegressionConstants.FIREWALL_ZSCALAR);
//		firewallLogsList.add(AuditWeeklyRegressionConstants.FIREWALL_BARRACUDA_ACTIVITYLOG);
//		firewallLogsList.add(AuditWeeklyRegressionConstants.FIREWALL_CHECKPOINT_CSV);
//		firewallLogsList.add(AuditWeeklyRegressionConstants.FIREWALL_CHECKPOINT_SMARTVIEW);
//		firewallLogsList.add(AuditWeeklyRegressionConstants.FIREWALL_JUNIPER_SRX);
//		firewallLogsList.add(AuditWeeklyRegressionConstants.FIREWALL_SCANSAFE);
//		//GS results are not available for the below logs
//		firewallLogsList.add(AuditWeeklyRegressionConstants.FIREWALL_CISCO_ASA_SERIES);
//		firewallLogsList.add(AuditWeeklyRegressionConstants.FIREWALL_JUNIPER_SCREENOS);
//		firewallLogsList.add(AuditWeeklyRegressionConstants.FIREWALL_CISCO_WSA_W3C);
//		firewallLogsList.add(AuditWeeklyRegressionConstants.FIREWALL_PALOALTO_CSV);
//		firewallLogsList.add(AuditWeeklyRegressionConstants.FIREWALL_CISCO_CWS);
//
//		return firewallLogsList;
//	}
//
//
//	public static final String FIREWALL_BE_ZSCALER_TEST = "audit_weekly_be_zscler_test";
//
