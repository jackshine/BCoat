...
public class DetectBBIEndtoEndTests_API extends DetectUtils{
	...
	List<String> messageList =	createProfile(suiteData.getSaasAppUsername(), attributeBean);
	List<String> messageList1 =	createIncident(suiteData.getSaasAppUsername(), attributeBean);
	//verifyActivityCount(suiteData.getSaasAppUsername(), messageList1);
	...
	@Test()    
	public void googleDrive_upload_BBI_Test(Method method) throws Exception{
		try {
	...
	//@Test(dependsOnMethods={"googleDrive_upload_BBI_Test"})    
	public void googleDrive_download_BBI_Test(Method method) throws Exception{
		try {
			
			validateIncidents(IOI_Code.ANOMALOUSLY_LARGE_DOWNLOAD.toString());
	...
	@Test
	public void googleDrive_Share_BBI_Test(Method method) throws Exception{
		try {
	...
	//@Test
	public void googleDrive_F_Share_BBI_Test(Method method) throws Exception{
		try {
	...
	private List<String> createIncident(String saasAppUsername, AttributeBean attributeBean) throws InterruptedException, IOException {
		if(attributeBean.isEnabled()){
			
				
				final String[] FILE_NAME = {"1mb001.bin","10MB.zip","10MB.zip","10MB.zip","10MB.zip","10MB.zip"};
				...
				for (int j = 0; j < FILE_NAME.length; j++) {
					...
					InputStream is = gdrive.downloadFile(filedId);
					Thread.sleep(1*2*1000);
					//messageList.add("User downloaded file "+filedId);
	...
	private List<String> createProfile(String saasAppUsername, AttributeBean attributeBean) throws InterruptedException, IOException {
		
		List<String> messageList = new ArrayList<>();
		
		if(attributeBean.isEnabled()){
				final String[] FILE_NAME = {"computing.doc","design_source.doc","encrypted_source.bin","computing.doc","design_source.doc","encrypted_source.bin","computing.doc","design_source.doc","encrypted_source.bin","computing.doc","design_source.doc","encrypted_source.bin",
						"computing.doc","design_source.doc","encrypted_source.bin","computing.doc","design_source.doc","encrypted_source.bin","computing.doc","design_source.doc","encrypted_source.bin","computing.doc","design_source.doc","encrypted_source.bin",
						"computing.doc","design_source.doc","encrypted_source.bin","computing.doc","design_source.doc","encrypted_source.bin","computing.doc","design_source.doc",
						"computing.doc","design_source.doc","encrypted_source.bin","computing.doc","design_source.doc","computing.doc","design_source.doc","encrypted_source.bin","computing.doc","design_source.doc","computing.doc","design_source.doc","encrypted_source.bin","computing.doc","design_source.doc"};
