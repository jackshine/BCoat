...
public class TokenProduce {
    ...
    public TokenProduce(String clientId, String clientSecret, String authorizationCode) {
    ...
    public TokenProduce(String clientId, String clientSecret, String authorizationCode, String refreshToken) {
        this.clientId = clientId;
        this.clientSecret = clientSecret;
        this.authorizationCode = authorizationCode;
        this.oAuth20Token = new OAuth20Token();
